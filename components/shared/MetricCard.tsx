...
const COLOR_MAP = {
  orange: {
    bg: 'from-orange-500/15 to-orange-600/5 border-orange-500/20',
...
export function MetricCard({
  ...
  return (
    <div
      className={`relative p-6 bg-gradient-to-br ${colors.bg} border rounded-2xl overflow-hidden transition-all duration-200 hover:scale-[1.02] hover:shadow-lg ${colors.shadow} ${className}`}
    >
      {/* Subtle glow */}
